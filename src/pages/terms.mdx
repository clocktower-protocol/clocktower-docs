...
See [REST authentication](/docs/developers/REST%20API/authentication), [REST chain selection](/docs/developers/REST%20API/chain-selection), [MCP chain selection](/docs/developers/MCP/mcp-chain-selection), and [MCP connection](/docs/developers/MCP/connection).
