...
While we have called these entities "users" up to now it's important to understand that they could be humans or bots. Due to the nature of Ethereum accounts there's also nothing stopping a user from being multiple roles at the same time. 
