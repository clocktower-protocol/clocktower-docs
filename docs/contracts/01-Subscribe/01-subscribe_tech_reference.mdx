...
:::info Integrating with Clocktower?
For HTTP/MCP access and the TypeScript SDK, see the [Developers](/docs/developers/) section. This page documents the on-chain contract API (structs, functions, and error codes).
:::
