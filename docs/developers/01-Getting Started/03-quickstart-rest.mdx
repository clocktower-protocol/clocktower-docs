...
`amount` is a human-readable token string (e.g. `"10"`), not protocol wei. `frequency` is `0` weekly, `1` monthly, `2` quarterly, `3` yearly.
...
See [Create subscription workflow](/docs/developers/Workflows/create-subscription).
