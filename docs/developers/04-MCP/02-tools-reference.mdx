...
Protocol tools accept optional `chainId` (`8453`, `"8453"`, or `"eip155:8453"`). Omitted uses Base. Invalid values return `INVALID_INPUT`. See [MCP chain selection](/docs/developers/MCP/mcp-chain-selection).
