...
Full prepare runs on-chain simulation before x402 payment settles. Failed simulation throws — you are not charged. Prefer `*_by_id` tools when the subscription id is known.