...
A prepare call consumes **write RPM**, **write daily**, and **daily total**. `POST /check_subscribe_readiness_by_id` is **not** in the write bucket (cheap / global RPM only — it does not run on-chain simulation).
