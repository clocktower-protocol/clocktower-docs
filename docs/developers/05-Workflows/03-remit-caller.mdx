...
3. **Sign & broadcast** — caller wallet signs and your bot sends to Base.
...
|------|------|----------|-----|
| 1. Readiness | `POST /api/check_remit_readiness` | `check_remit_readiness` | `checkRemitReadiness()` |
| 2. Prepare | `POST /api/prepare/remit` | `prepare_remit` | `remit()` |
