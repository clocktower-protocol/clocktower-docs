...
Las sesiones Builder pueden usar rutas prepare/readiness en forma objeto. Las variantes de escritura `*_by_id` **no** están en el alcance de entitlement Builder y devuelven **403** `FORBIDDEN`. Ver [Endpoints de escritura](/docs/developers/REST%20API/write-endpoints).