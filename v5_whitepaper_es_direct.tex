...
\begin{figure}[h]
\centering
\includegraphics[width=0.75\textwidth]{static/img/fig1.jpg}
\caption{Creación}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.75\textwidth]{static/img/fig2.jpg}
\caption{Iniciación}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.75\textwidth]{static/img/fig3.jpg}
